...
// 8
final class Animator2: NSObject, UIViewControllerAnimatedTransitioning {
    ...
    // 10
    init?(type: PresentationType, firstViewController: CollectionViewController, secondViewController: SecondViewController, selectedCellImageViewSnapshot: UIView) {
        self.type = type
